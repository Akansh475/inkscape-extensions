...
class Nup(inkex.Effect):
    def __init__(self):
        ...
        opts = [('--unit', str, 'unit', 'px', ''),
                ...
                ('--sizeX', str, 'sizeX', '', ''),
                ('--sizeY', str, 'sizeY', '', ''),
                ('--calculateSize', inkex.inkbool, 'calculateSize', True, ''),
                ('--pgMarginTop', str, 'pgMarginTop', '', ''),
                ('--pgMarginBottom', str, 'pgMarginBottom', '', ''),
                ('--pgMarginLeft', str, 'pgMarginLeft', '', ''),
                ('--pgMarginRight', str, 'pgMarginRight', '', ''),
                ('--showHolder', inkex.inkbool, 'showHolder', True, ''),
                ('--showCrosses', inkex.inkbool, 'showCrosses', True, ''),
                ('--showInner', inkex.inkbool, 'showInner', True, ''),
                ('--showOuter', inkex.inkbool, 'showOuter', False, ''),
                ('--showInnerBox', inkex.inkbool, 'showInnerBox', False, ''),
                ('--showOuterBox', inkex.inkbool, 'showOuterBox', False, ''),
                ('--tab', str, 'tab', '', ''),
                ]
        for o in opts:
