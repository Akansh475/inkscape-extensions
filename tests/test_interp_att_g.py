...
class InterpAttGOtherAttributeTest(ComparisonMixin, TestCase):
    ...
    effect_class = InterpAttG
    compare_file = 'svg/group_interpolate.svg'
    comparisons = [('--id=g53', '--att=other', '--att-other=width', '--start-val=5', '--end-val=10', '--att-other-type=ValueInterpolator'),
    ('--id=g53', '--att=other', '--att-other=fill', '--att-other-where=style', '--start-val=red', '--end-val=green', '--att-other-type=ColorInterpolator')]

class InterpAttGTransformInterpolateTest(ComparisonMixin, TestCase):
    effect_class = InterpAttG
    compare_file = 'svg/group_interpolate.svg'
    comparisons = [('--id=g53', '--att=transform/scale', '--start-val=0.2', '--end-val=0.9'),
    ('--id=g53', '--att=transform/trans-x', '--start-val=0', '--end-val=20')]

class InterpAttGUnitsTest(ComparisonMixin, TestCase):
    effect_class = InterpAttG
    compare_file = 'svg/group_interpolate.svg'
    comparisons = [('--id=g53', '--att=width', '--start-val=0.02', '--end-val=0.1', '--unit=mm')]