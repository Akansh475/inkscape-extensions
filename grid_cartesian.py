...
class GridCartesian(inkex.GenerateExtension):
    def __init__(self):
        ...
        self.arg_parser.add_argument("--x_log", type=inkex.inkbool, dest="x_log", default="false")
        ...
        self.arg_parser.add_argument("--y_log", type=inkex.inkbool, dest="y_log", default="false")
