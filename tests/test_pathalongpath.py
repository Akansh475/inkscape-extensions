...
class TestPathAlongPathBasic(ComparisonMixin, TestCase):
    ...
    comparisons = [
        ...
        ('--copymode=Repeated, stretched', '--kind=Ribbon', '--vertical=True',
         '--id=g3961', '--id=path10007'),
        # Settings: Repeated, Stretched, Ribbon
        # Tests a group pattern with multiple nested clones
        ('--copymode=Repeated, stretched', '--kind=Ribbon',
         '--id=g4054', '--id=path4056'),
        ...
        # skeleton path
        ('--copymode=Single, stretched', '--kind=Snake',
         '--id=text4418', '--id=path4412'),
        # Settings: Single, Stretched, Snake.
        # Tests selecting multiple sceleton paths, one consisting of multiple subpaths
        ('--copymode=Single, stretched', '--kind=Snake',
         '--id=path4585', '--id=path4608', '--id=path4610', '--id=path4612'),
        ...
        ('--copymode=Repeated, stretched', '--kind=Snake', '--noffset=5', '--space=5',
         '--id=path2408', '--id=path2405'),
    ]
...
class TestPathAlongPathCloneTransforms(ComparisonMixin, TestCase):
    ...
    comparisons = [
        ...
        ("--copymode=Single", "--duplicate=True", "--kind=Snake", "--id=g5848", "--id=path3336") 
    ]